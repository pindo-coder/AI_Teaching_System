...
const form = reactive({ source_title: '', course_id: undefined as number | undefined, chapter_id: undefined as number | undefined, knowledge_point: '' })
