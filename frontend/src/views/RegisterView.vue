...
<template>
  <main class="auth-page">
    <section class="auth-intro"><el-tag effect="dark" round>学生账号</el-tag><h1>创建你的<br />智能学习空间</h1><p>注册账号，开始课程化、阶段化的学习体验。</p></section>
    <el-card class="auth-card" shadow="never">
      <h2>创建账号</h2><p class="muted">公开注册账号的默认角色为学生</p>
