  ...
  <el-container class="app-layout">
    <el-container>
      <el-header class="topbar">
        ...
        <nav class="topbar-links"><router-link to="/classes">教学班</router-link><router-link to="/courses">课程中心</router-link><router-link to="/assignments">学习任务</router-link><router-link to="/notes">笔记空间</router-link><router-link to="/reviews">今日复习</router-link><router-link to="/interaction">课堂互动</router-link></nav>
        <el-dropdown>
