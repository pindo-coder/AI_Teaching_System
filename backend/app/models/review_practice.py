...
class ReviewPractice(Base):
    ...
    ai_reference_answer: Mapped[str] = mapped_column(Text, default="", nullable=False)
    reference_knowledge_points: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    reference_cache_key: Mapped[str] = mapped_column(Text, default="", nullable=False)
